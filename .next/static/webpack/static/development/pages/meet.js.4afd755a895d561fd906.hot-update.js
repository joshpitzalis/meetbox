...
/* harmony import */ var _features_schedule_helpers_timeBarHelpers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../features/schedule/helpers/timeBarHelpers */ "./features/schedule/helpers/timeBarHelpers.js");
/* harmony import */ var _sideEffects_firebase__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../sideEffects/firebase */ "./sideEffects/firebase.js");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            slug = url.query.slug;
            _context.next = 3;
            return _sideEffects_firebase__WEBPACK_IMPORTED_MODULE_7__["default"].firestore().collection("meetings").doc(slug).get().then(function (doc) {
...
function index(_ref2) {
  ...
  // {url.query.slug}
  var options = _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_0___default()(JSON.parse(meetings.options));

  console.log(options);
  {
    Object(date_fns__WEBPACK_IMPORTED_MODULE_3__["format"])(new Date(date), "do MMMM");
  }
  {
    " ";
  }
  react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("span", {
    className: "f2 pl3"
  }, Object(_features_schedule_helpers_timeBarHelpers__WEBPACK_IMPORTED_MODULE_6__["convertToTimeInterval"])(time));
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_5__["default"], null, react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("h1", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("article", {
      ...
      className: "f4"
    }, option[0]), react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("hr", {
...
//# sourceMappingURL=meet.js.4afd755a895d561fd906.hot-update.js.map