      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            slug = url.query.slug;
            _context.next = 3;
            return _sideEffects_firebase__WEBPACK_IMPORTED_MODULE_4__["default"].firestore().collection("meetings").doc(slug).get().then(function (doc) {
...
function index(_ref2) {
  var url = _ref2.url,
      ...
      slug = _ref2.slug;
  // {url.query.slug}
  console.log(JSON.parse(meetings.options));
...
//# sourceMappingURL=meet.js.2ad4a1516945865f7893.hot-update.js.map