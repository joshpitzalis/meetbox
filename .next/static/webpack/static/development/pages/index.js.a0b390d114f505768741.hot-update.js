      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return _sideEffects_firebase__WEBPACK_IMPORTED_MODULE_12__["default"].firestore().collection("meetings").add({
  ...
  states: {
    ...
    loading: {
      invoke: {
        ...
        onDone: {
          target: "ready" // actions: (context, event) => event.data

        },
        onError: {
          target: "failure" // actions: assign({ error: (context, event) => event.data })
...
function index(_ref3) {
  ...
  })), current.value === "ready" && next_router__WEBPACK_IMPORTED_MODULE_7___default.a.push("/meet/".concat(current.event.data))));
}
...
//# sourceMappingURL=index.js.a0b390d114f505768741.hot-update.js.map