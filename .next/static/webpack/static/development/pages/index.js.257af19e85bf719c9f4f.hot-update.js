...
function TimeBar(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("section", {
    ...
    __self: this
  }, "Select up to 3 times..."), dates && _babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(dates).map(function (_ref2) {
...
var TimeBlock = function TimeBlock(_ref6) {
  var time = _ref6.time,
      date = _ref6.date,
      setDates = _ref6.setDates,
      dates = _ref6.dates;
  // console.log(time, date, setDates, dates);
...
//# sourceMappingURL=index.js.257af19e85bf719c9f4f.hot-update.js.map