...
/* harmony import */ var _static_svg_NextStep_jsx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../static/svg/NextStep.jsx */ "./static/svg/NextStep.jsx");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return _sideEffects_firebase__WEBPACK_IMPORTED_MODULE_11__["default"].firestore().collection("meetings").add({
  ...
  states: {
    ...
    loading: {
      invoke: {
        ...
        onDone: {
          target: "ready",
          actions: Object(xstate__WEBPACK_IMPORTED_MODULE_7__["assign"])({
            slug: function slug(context, event) {
              return event.data;
            }
          })
        },
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _sideEffects_firebase__WEBPACK_IMPORTED_MODULE_11__["default"].firestore().collection("meetings").get().then(function (collection) {
...
function index(_ref3) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_8__["default"], null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("section", {
    ...
    className: "f1"
  }, "Pick up to 3 dates to meet..."), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_features_schedule_components_Calendar__WEBPACK_IMPORTED_MODULE_9__["default"], {
    handleSelect: setDates,
    dates: dates
  }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_static_svg_NextStep_jsx__WEBPACK_IMPORTED_MODULE_12__["default"], {
    action: function action() {
      return send("CONFIRMED_DATES");
    },
    className: "pointer grow"
  })), current.value === "times" && react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_features_schedule_components_TimeBar__WEBPACK_IMPORTED_MODULE_10__["default"], {
    dates: dates,
    send: send,
    setDates: setDates
  }), react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_static_svg_NextStep_jsx__WEBPACK_IMPORTED_MODULE_12__["default"], {
  ...
  })), current.value === "ready" && Router.push("/meet/".concat(current.event.data))));
}
...
//# sourceMappingURL=index.js.5e0d737e63331dc062c1.hot-update.js.map