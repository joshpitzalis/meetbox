      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            slug = url.query.slug;
            _context.next = 3;
            return _sideEffects_firebase__WEBPACK_IMPORTED_MODULE_5__["default"].firestore().collection("meetings").doc(slug).get().then(function (doc) {
...
function index(_ref2) {
  ...
  console.log(options); // {format(new Date(date), "do MMMM")}{" "}
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], null, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("h1", {
    className: "f1 tc"
  }, "Pick a time..."), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("section", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("article", {
      ...
      className: "f4"
    }, option[0]), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("hr", {
...
//# sourceMappingURL=meet.js.7dc0f63d64c3e59998ae.hot-update.js.map