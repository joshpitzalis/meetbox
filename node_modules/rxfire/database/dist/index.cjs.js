...
function list(query, events) {
    ...
    return fromOnce(query).pipe(operators.switchMap(function (change) {
        ...
        try {
            for (var eventsList_1 = __values(eventsList), eventsList_1_1 = eventsList_1.next(); !eventsList_1_1.done; eventsList_1_1 = eventsList_1.next()) {
                var event_1 = eventsList_1_1.value;
            ...
            try {
                if (eventsList_1_1 && !eventsList_1_1.done && (_a = eventsList_1.return)) _a.call(eventsList_1);
            }
    ...
    switch (event) {
        ...
        case exports.ListenEvent.added:
            if (currentKeyPosition > -1) {
                ...
                return __spread([change], current);
            }
            else {
